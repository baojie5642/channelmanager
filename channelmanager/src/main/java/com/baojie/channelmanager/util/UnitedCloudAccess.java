...
public class UnitedCloudAccess {

	private final Sync sync;

	public static UnitedCloudAccess create() {
		return create(false);
	}

	public static UnitedCloudAccess create(final boolean setAccess) {
		return new UnitedCloudAccess(setAccess);
	}

	private UnitedCloudAccess() {
		this(false);
	}

	private UnitedCloudAccess(final boolean mutex) {
		sync = new Sync();
		set(mutex);
	}
